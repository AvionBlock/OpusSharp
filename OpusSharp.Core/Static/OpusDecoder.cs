...
{
    /// <summary>
    /// An opus decoder using static binding calls.
    /// </summary>
    public class OpusDecoder : IOpusDecoder
    {
        ...
        {
            var error = 0;
            _handler = StaticNativeOpus.opus_decoder_create(sample_rate, channels, &error);
            CheckError(error);
        }
        ...
        public unsafe int Decode(Span<byte> input, int length, Span<byte> output, int frame_size, bool decode_fec)
        {
            ...
            {
                var result = StaticNativeOpus.opus_decode(_handler, inputPtr, length, (short*)outputPtr, frame_size,
                    decode_fec ? 1 : 0);
                CheckError(result);
                return result;
            }
        ...
        public unsafe int Decode(Span<byte> input, int length, Span<short> output, int frame_size, bool decode_fec)
        {
            ...
            {
                var result = StaticNativeOpus.opus_decode(_handler, inputPtr, length, outputPtr, frame_size,
                    decode_fec ? 1 : 0);
                CheckError(result);
                return result;
            }
        ...
        public unsafe int Decode(Span<byte> input, int length, Span<int> output, int frame_size, bool decode_fec)
        {
            ...
            {
                var result = StaticNativeOpus.opus_decode24(_handler, inputPtr, length, outputPtr, frame_size,
                    decode_fec ? 1 : 0);
                CheckError(result);
                return result;
            }
        ...
        public unsafe int Decode(Span<byte> input, int length, Span<float> output, int frame_size, bool decode_fec)
        {
            ...
            {
                var result = StaticNativeOpus.opus_decode_float(_handler, inputPtr, length, outputPtr, frame_size,
                    decode_fec ? 1 : 0);
                CheckError(result);
                return result;
            }
        ...
        {
            ThrowIfDisposed();
            var result = StaticNativeOpus.opus_decoder_ctl_noargs(_handler, (int)request);
            CheckError(result);
            return result;
        }
        ...
        {
            ThrowIfDisposed();
            var result = StaticNativeOpus.opus_decoder_ctl_i(_handler, (int)request, value);
            CheckError(result);
            return result;
        }
        ...
        public unsafe int Ctl<T>(DecoderCTL request, ref T value) where T : unmanaged
        {
            ...
            {
                var result = StaticNativeOpus.opus_decoder_ctl_p(_handler, (int)request, valuePtr);
                CheckError(result);
                return result;
            }
        }

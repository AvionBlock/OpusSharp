...
nuget pack OpusSharp.iOS/OpusSharp.iOS.nuspec -OutputDirectory local-nuget
nuget pack OpusSharp.Linux/OpusSharp.Linux.nuspec -OutputDirectory local-nuget
